...
public class SkeletonKing : Character
{
    public SkeletonKing():base()
    {
        GameObject obj =  Resources.Load("Skeleton@Idle Variant") as GameObject;
        ...
        if (CharacterBehaiverController == null)
            CharacterBehaiverController = cloneObj.GetComponent<SkeletonKingBehavier>();
        ...
        Debug.Log("骷髅王初始状态："+ FMSystem.CurrentStateCode);
    }
